...
//
// หมายเหตุ: ช่อง billTo.name, billTo.address, signature และ terms คือจุดที่ใน
// ภาพต้นแบบทำเป็นตัวหนังสือสีแดง/เอียง (placeholder เช่น "[bill-to-name]")
// ถ้าลบค่าตรงนี้ออก/ปล่อยว่าง index.js จะโชว์ placeholder แบบเดียวกับต้นแบบ
// ให้อัตโนมัติ (ดูฟังก์ชัน textOrPlaceholder ใน index.js)
// ---------------------------------------------------------------------------
